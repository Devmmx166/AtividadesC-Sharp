...
class Program
{
    static void Main(string[] args)
    {
     ...
     float acrecimo = int.Parse(Console.ReadLine());
      ...
      Console.WriteLine($"O produto {nome} teve um acréscimo de {acrecimo}% e passou a custar {Math.Round(novoPreco,2)}"); //esse comando arredonda o valor para 2 casas decimais
